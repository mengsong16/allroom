from allroom.envs.mazelab.base_env import BaseMazeEnv
from allroom.envs.mazelab.motion import VonNeumannMotion
from allroom.envs.mazelab.maze import Maze
...
from allroom.envs.mazelab.solvers import dijkstra_solver
...
class MazeEnv(BaseMazeEnv):
    ...
    def load_maze(self, env_id):
        ...
        parent_dir = "/home/meng/allroom/allroom/envs/mazelab"
