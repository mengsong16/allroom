...
import numpy as np
from allroom.envs.gcsl_envs.env_utils import DiscretizedActionEnv
...
from allroom.envs.gcsl_envs.room_env import PointmassGoalEnv
...
register(
    ...
    entry_point='allroom.envs.gcsl_envs.room_env:PointmassRoomsEnv',
)

register(
    id='pointmass-empty-v0',
    entry_point='allroom.envs.gcsl_envs.room_env:PointmassEmptyEnv',
)

register(
    id='pointmass-wall-v0',
    entry_point='allroom.envs.gcsl_envs.room_env:PointmassWallEnv',
)

register(
    id='sawyerpush-v0',
    entry_point='allroom.envs.gcsl_envs.sawyer_push:SawyerPushGoalEnv',
)

register(
    id='sawyerdoor-v0',
    entry_point='allroom.envs.gcsl_envs.sawyer_door:SawyerDoorGoalEnv',
)

register(
    id='claw-v0',
    entry_point='allroom.envs.gcsl_envs.claw_env:ClawEnv',
)

register(
    id='lunargoal-v0',
    entry_point='allroom.envs.gcsl_envs.lunarlander:LunarEnv',
)
